import romajiHiraTable from './romaji-hira-table';

const useHiraganaConvert = () => {
  const convertForward = (input: string) => {
    let result = ''; // 変換結果の出力文字列
    let state = romajiHiraTable; // 解析の状態
...
export default useHiraganaConvert;
